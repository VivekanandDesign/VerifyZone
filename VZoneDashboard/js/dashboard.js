...
function initializeSidebarToggle() {
    ...
    toggleButton.addEventListener('click', function() {
        ...
        // Update toggle icon
        updateToggleIcon(toggleButton, isCollapsed);
...
function updateToggleIcon(button, isCollapsed) {
    ...
    if (isCollapsed) {
        ...
        svg.innerHTML = `<path d="M9 18L15 12L9 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>`;
    } else {
        // Hamburger menu icon for expanded state
        svg.innerHTML = `<path d="M3 12L21 12M3 6L21 6M3 18L21 18" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>`;
    }
}
